...
func newFile(db *gorm.DB, opts ...gen.DOOption) file {
	...
	_file.ParentID = field.NewInt32(tableName, "parent_id")
	...
	_file.VerNum = field.NewInt32(tableName, "ver_num")
	_file.StoreKey = field.NewString(tableName, "store_key")
	_file.Ctime = field.NewInt32(tableName, "ctime")
	_file.Mtime = field.NewInt32(tableName, "mtime")
...
func (f *file) updateTableName(table string) *file {
	...
	f.VerNum = field.NewInt32(table, "ver_num")
	f.StoreKey = field.NewString(table, "store_key")
	f.Ctime = field.NewInt32(table, "ctime")
	f.Mtime = field.NewInt32(table, "mtime")
...
func (f *file) fillFieldMap() {
	...
	f.fieldMap["ver_num"] = f.VerNum
	f.fieldMap["store_key"] = f.StoreKey

...
func newVersion(db *gorm.DB, opts ...gen.DOOption) version {
	...
	_version.FileID = field.NewInt32(tableName, "file_id")
	_version.Size = field.NewInt32(tableName, "size")
	_version.VerNum = field.NewInt32(tableName, "ver_num")
	_version.StoreKey = field.NewString(tableName, "store_key")
	_version.Ctime = field.NewInt32(tableName, "ctime")
...
func (v *version) updateTableName(table string) *version {
	...
	v.FileID = field.NewInt32(table, "file_id")
	v.Size = field.NewInt32(table, "size")
	v.VerNum = field.NewInt32(table, "ver_num")
	v.StoreKey = field.NewString(table, "store_key")
	v.Ctime = field.NewInt32(table, "ctime")
...
func (v *version) fillFieldMap() {
	...
	v.fieldMap["id"] = v.ID
	v.fieldMap["file_id"] = v.FileID
	v.fieldMap["size"] = v.Size
	v.fieldMap["ver_num"] = v.VerNum
	v.fieldMap["store_key"] = v.StoreKey
